...
public class MenuGerente extends javax.swing.JFrame {
    ...
    public MenuGerente(int nroAgen) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MenuClientesGerente.menuClientesGerente(this.nroAgen);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        MenuContasGerente.menuContasGerente(this.nroAgen);
    ...
    public static void menuGerente(int nroAgen) {
        try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MenuGerente menuGeren = new MenuGerente(nroAgen);
                menuGeren.setLocationRelativeTo(null);
                menuGeren.setVisible(true);
            }
        });
    }
